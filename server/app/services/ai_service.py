...
async def generate_code_from_image(base64_image: str) -> str:
    gemini_api_key = os.getenv("GEMINI_API_KEY")
    openai_api_key = os.getenv("OPENAI_API_KEY")

    # Use Gemini first when GEMINI_API_KEY is configured, without requiring openai package.
    if gemini_api_key:
        return await _generate_with_gemini_http(base64_image, gemini_api_key)
...
async def _generate_with_gemini_http(base64_image: str, api_key: str) -> str:
    import asyncio
    import json
